...
// In Swift, both sides need to be doubles in order for this division to work
...
{
    println("Woot! You beat the old high score of \(highScore)!!!")
    highScore = score
}
...
func printHighScore()
{
    println("The high score is \(highScore)")
}

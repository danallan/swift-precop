...
class ViewController: UIViewController {
    ...
    func threeButtonActionSheet()
    {
        ...
        { (action) in
            print("User wants a board that's quick to solve!")
        }
        alert.addAction(easy)
        
        let med = UIAlertAction(title: "Med", style: .Default)
        { (action) in
            print("User wants a board with medium difficulty!")
        }
        alert.addAction(med)
        
        let hard = UIAlertAction(title: "Hard", style: .Default)
        { (action) in
            print("User wants a difficult board!")
        }
